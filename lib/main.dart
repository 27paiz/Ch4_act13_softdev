// จงสร้างโปรแกรม
// Flutter โดยรับข้อมูลอินพุทเป็น
// “ชื่อ
// นามสกุล,ที่อยู่,
// เบอร์โทรศัพท์,
// ชื่อ
// user (E-mail)
// และ รห้ส password”
// และให้แสดงข้อความ ยินดีต้อนรับเข้าระบบ
// ตามด้วยชื่อและนามสกุล เช่น “Welcome to Animate System, Mr. Michael Anotho” พร้อมด้วยที่อยู่,
// เบอร์โทรศัพท์
